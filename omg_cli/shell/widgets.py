...
class ComposerTextArea(TextArea):
    ...
    def __init__(self, *, placeholder: str = "") -> None:
        ...
        from omg_cli.config import InputHistory
...
class ApprovalDialog(Vertical):
    ...
    OPTIONS: ClassVar[list[tuple[str, str, ToolConfirmationDecision | None]]] = [
    ...
    def __init__(self, tool_name: str, arguments: str) -> None:
        ...
        self.mouse_enabled = True
        self.can_focus = True
        self._future: Future[ToolConfirmationDecision | None] = Future()
